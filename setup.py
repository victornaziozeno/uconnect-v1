...
# Este arquivo é um script de automação em Python, projetado para simplificar a configuração e o início do projeto. Ele executa duas tarefas principais: primeiro, instala todas as dependências necessárias listadas no arquivo requirements.txt; em seguida, inicia o servidor da API FastAPI usando uvicorn com o modo de recarregamento automático ativado.
import subprocess
import sys
import os
...
def main():
    ...
    if os.path.exists(requirements_file):
        ...
        install_command = [sys.executable, '-m', 'pip', 'install', '--upgrade', '--user', '-r', requirements_file]
